...
function Dashboard({ account, vehicle, onReserve, activeReservation, onEndReservation, onReportIncident }) {
  const [spots] = useState(mockSpots.filter(s => s.zone !== "D"));
...
// TEACHER DASHBOARD
// ════════════════════════════════════════════════════════════════════════════════
function TeacherDashboard({ account, vehicle, onReserve, activeReservation, onEndReservation, onReportIncident }) {
